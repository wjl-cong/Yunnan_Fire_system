...
// 获取 Top 7 日期
const top7Days = geoData.dailyCounts
...
const option = {
  ...
  xAxis: {
    type: 'category',
    data: top7Days.map(item => item.name),
  ...
  series: [
    {
      name: '火点频次',
      type: 'bar',
      data: top7Days.map(item => item.value),
      itemStyle: {
    ...
    <Teleport to="body">
      <div v-if="isMaximized" class="maximized-view">
        <div class="header-bar">
          <span class="max-title">高频火点日期详情</span>
        ...
        <div class="content-container">
          ...
          <el-table-column prop="acq_time" label="时间" width="100" />
