...
const option = {
  ...
  xAxis: {
    type: 'category',
    data: Object.keys(geoData.frpDistribution),
    axisLabel: { color: '#fff' },
  ...
  series: [
    {
      name: '火点数量',
      type: 'bar',
      data: Object.values(geoData.frpDistribution),
      itemStyle: {
...
const initMaxChart = () => {
  if (maxChartRef.value) {
    ...
    maxChartInstance.setOption(option)
  }
}
    ...
    <Teleport to="body">
      <div v-if="isMaximized" class="maximized-view">
        <div class="header-bar">
          <span class="max-title">辐射功率(FRP)分布详情</span>
          ...
          <div class="table-area">
            <div class="table-content-wrapper">
              ...
              >
                  ...
                  <el-table-column prop="frp" label="辐射功率(MW)" min-width="140" sortable />
                  <el-table-column prop="brightness" label="亮度(K)" min-width="120" sortable />
